...
!  CHARACTER(LEN=256) :: file_name = "/SCIA/SDMF31/pieter/sdmf_smooth_pyxelmask32.h5"
  CHARACTER(LEN=256) :: file_name = "/SCIA/SDMF31/pieter/sdmf_smooth_pyxelmask32_mar2015.h5"
  ...
  ! read pixel mask for a single orbit (channel 8)
  ! orbit: absolute orbit [1..53000]
  SUBROUTINE read_quality_mask(orbit, data, error) 
    INTEGER, INTENT(IN) :: orbit
  ...
  END SUBROUTINE read_quality_mask
